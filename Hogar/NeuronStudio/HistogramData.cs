...
namespace NeuronStudio
{
    ...
    static class HistogramData
    {
        ...
        static private DataSet GetFigures(List<Pair> pairs)
        {
            var dataSet = new DataSet();
            DataTable dataTable = dataSet.Tables.Add();

            dataTable.Columns.Add("SignalStrength", typeof(double));
        ...
        static public DataSet Create(List<double> values, int partitions)
        {
